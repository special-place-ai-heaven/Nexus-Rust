...
3. ~~`#54` load order~~ — **settled** in `CONFORMANCE.md` §2.8: sorted-and-batched, already implemented and tested; batching is unobservable because the ABI has no addon-enumeration function.
